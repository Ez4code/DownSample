...
unsigned short ccs_jpgfile::swap_bytes(unsigned short b)
{
...
void ccs_jpgfile::writebits()
{
  unsigned char o = outbyte;
  writebytes(&o, 1);
}

void ccs_jpgfile::flush()
{
...
void ccs_jpgfile::pushbit(unsigned char c)   // 1 or 0
{
...
void ccs_jpgfile::write(unsigned char numbits, unsigned int bits)
{
...
void ccs_jpgfile::write_SOF0(unsigned short height, unsigned short width)
{
...
void ccs_jpgfile::writepreamble(unsigned short height, unsigned short width)
{
  write_SOI();
  write_APP0();
  write_DQT();
...
void ccs_jpgfile::writepostscript()
{
